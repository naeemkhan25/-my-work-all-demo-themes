    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mission section">
                <h1 class="heading" id="customHeading">
					<?php
                ...
                <?php
                if(get_theme_mod("cust_services_description_check",1)){
                ?>
                <p class="subheading">
                    <?php
                    echo esc_html(get_theme_mod('cust_services_description'),__('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet animi dolorem eveniet
                ...
                <div class="row sub-section">
                    <?php
                    $per_page_row=get_theme_mod("cust_services_row",4);
                    ?>
                    <div class="col-md-<?php echo $per_page_row;?>">
                        <div class="service">
